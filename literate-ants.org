...
+ The benefits of LP+Emacs+Org:
  1. Coherence: a unified, single-file approach to software
     ...
     coherently bound in one format.
...
+ Essentials
  ...
  - Within a code block, =CTRL-c-'= will open a buffer to edit the
    ...
    =nrepl= are installed.
  - More on Org: [[http://orgmode.org/org.html][main documentation]] especially sections on [[http://orgmode.org/org.html#Document-Structure][structure]],
